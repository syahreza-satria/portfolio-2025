...
export const experience = [
  {
    id: 6,
    logo: "/assets/experience/lac.png",
  ...
  },
  {
    ...
    description: [
      "Designed the user interface and overall user experience for a specialized financial application utilized by the CAATIS-RA Laboratory.",
  ...
  },
  {
    ...
    position: "Tutor",
    description: [
      "Delivered comprehensive Bahasa Indonesia tutoring to international students, integrating practical language instruction with deep explorations of Indonesian culture, customs, and heritage.",
      "Systematically monitored and documented individual student progress to track language acquisition milestones and overall cultural comprehension.",
      "Conducted regular evaluations to identify specific learning gaps and areas for improvement, providing tailored feedback to refine future teaching strategies.",
